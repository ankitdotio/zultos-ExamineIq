    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-text-secondary font-body text-base">Create your account and start learning!</p>
        </div>

        {/* Signup Form */}
        <div className="bg-white rounded-card-lg border border-border shadow-[0_2px_12px_rgba(23,40,74,0.08)] p-8">
          <h2 className="text-2xl font-bold font-heading text-navy mb-6">Sign Up</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="text-xs text-text-muted font-body mt-1.5">Must be at least 6 characters</p>
            </div>

            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium font-body text-navy mb-2">
                Confirm Password
              </label>
              <input
                type="password"
            ...
            <div className="flex items-start pt-1">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 text-cyan focus:ring-cyan border-border rounded mt-1"
              />
              <label htmlFor="terms" className="ml-2.5 block text-sm font-body text-text-secondary leading-relaxed">
                I agree to the{' '}
                <a href="#" className="text-cyan hover:text-cyan/80 transition font-medium">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm font-body text-text-secondary">
              ...
              <Link href="/login" className="font-medium text-cyan hover:text-cyan/80 transition">
                Login
              </Link>
            </p>
          </div>
